...
X Integrate stage controller from gantryControl.py
...
from stage_controller import StageController  # Import the new stage controller
...
class MainWindow(QMainWindow): # Main GUI for controlling photolithography settings and image
    def __init__(self):
        ...
        self.camera_viewport.setMinimumHeight(200)
        
        # Add the integrated stage controller
        self.stage_controller = StageController()

        self.layout_left.addWidget(self.camera_label)
        self.layout_left.addWidget(self.camera_viewport)
        self.layout_left.addWidget(self.stage_controller)
